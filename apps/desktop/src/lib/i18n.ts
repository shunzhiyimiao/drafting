...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "git.fetch": { zh: "获取", en: "Fetch" },
  "git.upToDate": { zh: "已是最新", en: "Already up to date" },
  "git.behind.hint": { zh: "远端领先 {n} 个提交，可拉取", en: "{n} commit(s) behind — pull to update" },
  "git.fetch.done.title": { zh: "获取完成", en: "Fetch complete" },
  "git.fetch.failed.title": { zh: "获取失败", en: "Fetch failed" },
  "git.pull.done.title": { zh: "拉取完成", en: "Pull complete" },
  "git.pull.done.applied": { zh: "已快进 {n} 个提交", en: "Fast-forwarded {n} commit(s)" },
  "git.pull.failed.title": { zh: "拉取失败", en: "Pull failed" },
  "git.push.done.title": { zh: "推送完成", en: "Push complete" },
  "git.push.done.detail": { zh: "已推送 {n} 个提交到 {remote}", en: "Pushed {n} commit(s) to {remote}" },
  "git.push.failed.title": { zh: "推送失败", en: "Push failed" },
  ...
  "blueprint.check": { zh: "校验", en: "Validate" },
  "blueprint.aiCheck": { zh: "AI 检查", en: "AI Check" },
  "blueprint.aiCheckRunning": { zh: "AI 检查中…", en: "AI checking…" },
  "blueprint.aiCheckDone": { zh: "AI 检查完成，结果已写入 criteria", en: "AI check finished — results attached to criteria" },
